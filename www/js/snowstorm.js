...
var snowStorm = (function(window, document) {
  ...
  this.flakesMax = 98;           // Limit total amount of snow made (falling + sticking)
  this.flakesMaxActive = 90;      // Limit amount of snow falling at once (less = lower CPU use)
  this.flakesMinActive = 44;      // Try to keep at least X flakes active at all times
  this.flakeScale = 1.1;          // Percentage to scale flakes (1.0 default = normal size)
  this.animationInterval = 32;    // Theoretical "miliseconds per frame" measurement. 20 = fast + smooth, but high CPU use. 50 = more conservative, but slower
...
// this.use3DRotate = false;
  ...
  function checkFontFace() {
    ...
    */
    ...
    return supportAtRule('@font-face { font-family: "font"; src: "../css/fonts/wwflakes-webfont.ttf"; }');
    ...
    */
    ...
    text = {
      ...
      value: [
        ...
        "src: url('../css/fonts/wwflakes-webfont.eot');",
        "src: local('☺'), url('../css/fonts/wwflakes-webfont.woff') format('woff'), url('../css/fonts/wwflakes-webfont.ttf') format('truetype');",
        "font-weight: normal;",
        "font-style: normal;"
      ]
    };
