...
*/
  ...
  $message = preg_replace("#\[h2\](.+)\[\/h2\]#isU", '<h2 class="h2_bold">\\1</h2>', $message);
  $message = preg_replace("#\[h3\](.+)\[\/h3\]#isU", '<h3 class="h3_bold">\\1</h3>', $message);
  
  
  $message = preg_replace("#\[quote\](.+)\[\/quote\]#isU",'<div class="quoteHead">������</div><div class="quoteContent">\\1</div>',$message);
  $message = preg_replace("#\[quote=&quot;([- 0-9a-z�-��-�]{1,30})&quot;\](.+)\[\/quote\]#isU", '<div class="quoteHead">\\1 �����:</div><div class="quoteContent">\\2</div>', $message);
  ...
  $message = preg_replace("#\[img\][\s]*([\S]+)[\s]*\[\/img\]#isU",'<div class="pusher"></div><div class="img_posob"><img src="img/posobija/\\1" alt="" align="left" width="100%" border="0" /></div>',$message);
