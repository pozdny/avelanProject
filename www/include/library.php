...
*/
    ...
    $message = preg_replace("#\[color=orange\](.+)\[\/color\]#isU",'<span class="orange">\\1</span>',$message);
    $message = preg_replace("#\[color=green\](.+)\[\/color\]#isU",'<span class="green">\\1</span>',$message);
    $message = preg_replace("#\[color=blue\](.+)\[\/color\]#isU",'<span class="blue">\\1</span>',$message);
    $message = preg_replace("#\[color=darkblue\](.+)\[\/color\]#isU",'<span class="darkblue">\\1</span>',$message);
